...
// 2. Make an array of hashes to store the first name and last name for 3 
// different people. Then print out the first person's info.
let people = [
...
// 5. Make an array of hashes to store the title and author for 3 different 
// books. Then print out the third book's author.
let books = [
  {
    "title": "Moby Dick",
    "author": "Hermann Melville",
...
// For example, 
// {321 => {name: "Alice", age: 31}, 322 => {name: "Maria", age: 27}} becomes 
...
// 8. Combine data from a hash with names and prices and an array of hashes 
// with names, colors, and weights to make a new hash.
// For example,
// {"chair" => 75, "book" => 15} and 
// [{name: "chair", color: "red", weight: 10},
// {name: "book", color: "black", weight: 1}] becomes 
